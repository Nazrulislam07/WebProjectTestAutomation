...
|Information we collect|We collect information to provide better services|
|How we use information we collect|We use the information we collect from all|
...
|Accessing and updating your personal information|Whenever you use our services|
|Information we share|We do not share personal information with companies|
|Information security|We encrypt many of our services using SSL|
|When this Privacy Policy applies|Our Privacy Policy applies to all of the services|
|Compliance and cooperation with regulatory authorities|We regularly review our compliance|
|Changes|Our Privacy Policy may change from time to time|
|Specific product practices|The following notices explain specific privacy|
|Other useful privacy and security related materials|Further useful privacy and security related|
|Self Regulatory Frameworks|As described in our Privacy Shield certification|
|Key terms|Key terms|
|Partners|How Google uses data when you use our partners|
|Updates|We want to be as transparent as possible|
...
|How Google uses cookies|A cookie is a small piece of text sent to your browser|
